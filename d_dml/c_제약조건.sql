...
INSERT INTO `employees` VALUES (1, '진우태', 20);

INSERT INTO `employees` VALUES (2, '조민지', 19);
# 데이터 삽입 불가
...
-- VALUES
--     (1, '양현석', '1234');
--     (2, '양현석', null); -- 2, '양현석', null)' at line 1
--     (3, '성재원', '1234');
...
create table `cart` (
    ...
    -- default 제약조건
    -- 컬럼명 데이터타입 default 기본값(데이터타입 지켜야 함!)
...
VALUES
  (1, '노트북', 3),
  (2, '스마트폰', null), # null 값 입 시 null 값이 지정 (기본값 설정 X)
  (3, '태블릿', 2);

SELECT * from `cart`;

insert into `cart` (cart_id, product_name) VALUES (4, '이어폰');
